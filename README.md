...
```bash
curl "http://127.0.0.1:8000/api/v1/history?page=1&limit=20&symbol=US:QQQ"
```
...
- 标准输出 JSON（包含 `task_id/status/report_path/markdown_report_path/notification_sent/notification_channels`）
